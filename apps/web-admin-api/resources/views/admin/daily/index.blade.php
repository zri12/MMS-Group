...
@php
    ...
    $mainShortcuts = [
        ...
        ['label' => 'Lap. Operasional',    'count' => $counters['operational_reports'],'href' => route('admin.operational-reports.index', ['date_from' => $filters['date'], 'date_to' => $filters['date'], 'day' => $filters['day']]), 'icon' => 'M5 19V5m0 14h15M9 16V9m4 7V7m4 9v-5'],
